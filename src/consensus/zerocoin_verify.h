...
#ifndef ClearCoin_CONSENSUS_ZEROCOIN_VERIFY_H
#define ClearCoin_CONSENSUS_ZEROCOIN_VERIFY_H
...
bool RecalculateClearCoinupply(int nHeightStart, bool fSkipZclr = true);
