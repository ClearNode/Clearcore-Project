...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop ClearCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "ClearCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"clr", "listmasternodes", &listmasternodes, true },
        {"clr", "getmasternodecount", &getmasternodecount, true },
        {"clr", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"clr", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"clr", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"clr", "masternodecurrent", &masternodecurrent, true },
        {"clr", "startmasternode", &startmasternode, true },
        {"clr", "createmasternodekey", &createmasternodekey, true },
        {"clr", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"clr", "listmasternodeconf", &listmasternodeconf, true },
        {"clr", "getmasternodestatus", &getmasternodestatus, true },
        {"clr", "getmasternodewinners", &getmasternodewinners, true },
        {"clr", "getmasternodescores", &getmasternodescores, true },
        {"clr", "preparebudget", &preparebudget, true },
        {"clr", "submitbudget", &submitbudget, true },
        {"clr", "mnbudgetvote", &mnbudgetvote, true },
        {"clr", "getbudgetvotes", &getbudgetvotes, true },
        {"clr", "getnextsuperblock", &getnextsuperblock, true },
        {"clr", "getbudgetprojection", &getbudgetprojection, true },
        {"clr", "getbudgetinfo", &getbudgetinfo, true },
        {"clr", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"clr", "mnfinalbudget", &mnfinalbudget, true },
        {"clr", "checkbudgets", &checkbudgets, true },
        {"clr", "mnsync", &mnsync, true },
        {"clr", "spork", &spork, true },
