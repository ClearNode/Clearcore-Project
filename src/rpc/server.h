...
extern UniValue setzclreed(const JSONRPCRequest& request);
extern UniValue getzclreed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzclr(const JSONRPCRequest& request);
extern UniValue dzclrtate(const JSONRPCRequest& request);
