...
/* ClearCoin GUI -- Size of icons in status bar */
...
#define COLOR_UNCONFIRMED QColor(26, 91, 137)
/* Transaction list -- negative amount */
#define COLOR_NEGATIVE QColor(38, 76, 102)
/* Transaction list -- bare address (without label) */
#define COLOR_BAREADDRESS QColor(140, 140, 140)
/* Transaction list -- TX status decoration - open until date */
#define COLOR_TX_STATUS_OPENUNTILDATE QColor(8, 101, 165)
...
#define COLOR_STAKE QColor(43,71,241)
...
#define QAPP_ORG_NAME "ClearCoin"
#define QAPP_ORG_DOMAIN "clearnodes.com"
#define QAPP_APP_NAME_DEFAULT "ClearCoin-Qt"
#define QAPP_APP_NAME_TESTNET "ClearCoin-Qt-testnet"
