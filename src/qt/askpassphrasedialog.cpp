...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ClearCoinGUI* window = static_cast<ClearCoinGUI*>(parentWidget());
...
{
    ClearCoinGUI* gui = static_cast<ClearCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<ClearCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("ClearCoin will close now to finish the encryption process. "
