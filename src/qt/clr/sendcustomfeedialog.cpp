...
#include "qt/clr/sendcustomfeedialog.h"
#include "qt/clr/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ClearCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ClearCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
