...
#include "config/clr-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalClr = 0;
    qint64 totalZclr = 0;
    QList<qreal> valuesClr;
    QList<qreal> valueszClr;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(ClearCoinGUI* _window);
    ~DashboardWidget();
