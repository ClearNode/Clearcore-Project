...
#include "qt/clr/settings/settingswalletoptionswidget.h"
#include "qt/clr/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/clr/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ClearCoinGUI* _window, QWidget *parent) :
