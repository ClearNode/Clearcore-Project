...
#include "qt/clr/settings/settingssignmessagewidgets.h"
#include "qt/clr/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(ClearCoinGUI* _window, QWidget *parent) :
