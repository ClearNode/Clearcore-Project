...
#include "qt/clr/settings/settingsnetworkwidget.h"
#include "qt/clr/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/clr/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ClearCoinGUI* _window, QWidget *parent) :
