...
#include "qt/clr/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/clr/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(ClearCoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableCLR,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableCLR,
    ...
    connect(ui->pushButton_UnspendableCLR, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableCLR);});
    ...
    if (parent)
        connect(parent, &ClearCoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
