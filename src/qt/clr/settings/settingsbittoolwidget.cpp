...
#include "qt/clr/settings/settingsbittoolwidget.h"
#include "qt/clr/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(ClearCoinGUI* _window, QWidget *parent) :
