...
#include "qt/clr/settings/settingsbackupwallet.h"
#include "qt/clr/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/clr/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(ClearCoinGUI* _window, QWidget *parent) :
