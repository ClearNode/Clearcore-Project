...
#include "qt/clr/settings/settingsconsolewidget.h"
#include "qt/clr/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/clr/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(ClearCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ClearCoin RPC console.") + "<br>" +
