...
#include "qt/clr/settings/settingsexportcsv.h"
#include "qt/clr/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(ClearCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("ClearCoin_tx_csv_export(*.csv)") : tr("ClearCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
