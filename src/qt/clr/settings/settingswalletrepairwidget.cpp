...
#include "qt/clr/settings/settingswalletrepairwidget.h"
#include "qt/clr/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/clr/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ClearCoinGUI* _window, QWidget *parent) :
