...
#include "qt/clr/txviewholder.h"
#include "qt/clr/tooltipmenu.h"
#include "qt/clr/sendmultirow.h"
#include "qt/clr/coldstakingmodel.h"
#include "qt/clr/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(ClearCoinGUI* parent);
    ~ColdStakingWidget();
