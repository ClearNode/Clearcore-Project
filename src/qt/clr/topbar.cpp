...
#include "qt/clr/topbar.h"
#include "qt/clr/forms/ui_topbar.h"
#include "qt/clr/lockunlock.h"
#include "qt/clr/qtutils.h"
#include "qt/clr/receivedialog.h"
#include "qt/clr/loadingdialog.h"
...
TopBar::TopBar(ClearCoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopClr}, "amount-small-topbar");
    setCssProperty({ui->labelAmountClr}, "amount-topbar");
    setCssProperty({ui->labelPendingClr, ui->labelImmatureClr}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // CLR Total
    QString totalClr = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);

    // CLR
    // Top
    ui->labelAmountTopClr->setText(totalClr);
    // Expanded
    ui->labelAmountClr->setText(totalClr);
    ui->labelPendingClr->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureClr->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
