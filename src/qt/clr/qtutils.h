...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ClearCoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, ClearCoinGUI* gui, double posX = 3);
