...
public:
    ...
    bool WriteZClearCoineed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZClearCoineed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZClearCoineed_deprecated(uint256& seed);
    bool EraseZClearCoineed();
    bool EraseZClearCoineed_deprecated();

    bool WriteZCLRCount(const uint32_t& nCount);
    bool ReadZCLRCount(uint32_t& nCount);
