...
// CLR: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_BURNT_HEIGHT) r = SPORK_17_BURNT_HEIGHT_DEFAULT;
        if (nSporkID == SPORK_18_BURNT_VALUE) r = SPORK_18_BURNT_VALUE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_BURNT_HEIGHT") return SPORK_17_BURNT_HEIGHT;
    if (strName == "SPORK_18_BURNT_VALUE") return SPORK_18_BURNT_VALUE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_BURNT_HEIGHT) return "SPORK_17_BURNT_HEIGHT";
    if (id == SPORK_18_BURNT_VALUE) return "SPORK_18_BURNT_VALUE";
