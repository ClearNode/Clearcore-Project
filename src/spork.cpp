...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 CLR
    ...
    MAKE_SPORK_DEF(SPORK_19_BURNT_HEIGHT,                   4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_20_BURNT_VALUE,                    4070908800ULL), // OFF
};
