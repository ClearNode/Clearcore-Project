...
"""Verify that starting clr with -h works as expected."""
import subprocess

from test_framework.test_framework import ClearCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ClearCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start clr with -? for help text")
        ...
        self.log.info("Start clr with -version for version information")
