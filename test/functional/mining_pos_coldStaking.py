...
from test_framework.clr_node import ClearCoinTestNode
...
class ClearCoin_ColdStakingTest(ClearCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(ClearCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 CLR from the pot)
...
if __name__ == '__main__':
    ClearCoin_ColdStakingTest().main()
