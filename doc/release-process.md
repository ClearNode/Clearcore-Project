...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/ClearNode/ClearCoin/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/ClearNode/ClearCoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/ClearNode/gitian.sigs.git
    git clone https://github.com/ClearNode/ClearCoin-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/ClearNode/ClearCoin.git
...
By default, Gitian will fetch source files as needed. To cache them ahead of time, make sure you have checked out the tag you want to build in clr, then:
...
### Build and sign ClearCoin Core for Linux, Windows, and macOS:

    pushd ./gitian-builder
    ./bin/gbuild --num-make 2 --memory 3000 --commit clr=v${VERSION} ../clr/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit clr=v${VERSION} ../clr/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit clr=v${VERSION} ../clr/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. macOS unsigned installer and dist tarball (`clr-${VERSION}-osx-unsigned.dmg`, `clr-${VERSION}-osx64.tar.gz`)
...
Codesigner only: Sign the macOS binary:
    ...
    transfer clr-osx-unsigned.tar.gz to macOS for signing
...
- Detached signatures will then be committed to the [clr-detached-sigs](https://github.com/ClearNode/ClearCoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
clr-${VERSION}-riscv64-linux-gnu.tar.gz
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/ClearNode/ClearCoin/releases/new) with a link to the archived release notes.
