...
In order to support loading of multiple wallets in clr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is clr.cpp.
...
Changes to clr.cpp
----------------------
clr.cpp is the entry point into clr-qt, and as such, will require some minor modifications to provide hooks for
