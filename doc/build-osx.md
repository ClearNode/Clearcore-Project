...
1. Clone the AZUS Core source code:

        git clone https://github.com/AzusNodes/AZUS
        cd azus
...
AZUS Core is now available at `./src/azusd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PIVX"

    touch "/Users/${USER}/Library/Application Support/PIVX/azus.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PIVX/azus.conf"

The first time you run azusd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/azusd -daemon # Starts the azus daemon.
    ./src/azus-cli --help # Outputs a list of command-line options.
    ./src/azus-cli help # Outputs a list of RPC commands when the daemon is running.
