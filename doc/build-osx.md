...
1. Clone the CLR Core source code:

        git clone https://github.com/ClearNode/Clearcore-Project
        cd Clearcore-Project
...
When the intention is to run only a P2P node without a wallet, CLR Core may be compiled in
...
CLR Core is now available at `./src/clrd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PIVX"

    touch "/Users/${USER}/Library/Application Support/PIVX/clr.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PIVX/clr.conf"

The first time you run clrd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/clrd -daemon # Starts the clr daemon.
    ./src/clr-cli --help # Outputs a list of command-line options.
    ./src/clr-cli help # Outputs a list of RPC commands when the daemon is running.
