UNIX BUILD NOTES
====================
Some notes on how to build ClearCoin in Unix.
...
memory available when compiling ClearCoin Core. With 512MB of memory or less
...
above instead of `libssl-dev`. ClearCoin Core does not support the use of OpenSSL 1.1, though compilation is still possible
...
# Configure ClearCoin Core to use our own-built instance of BDB
cd $CLR_ROOT
...
Security
--------
To help make your ClearCoin installation more secure by making certain attacks impossible to
...
When the intention is to run only a P2P node without a wallet, ClearCoin Core may be compiled in
