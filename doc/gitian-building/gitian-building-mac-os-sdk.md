...
The script [extract-osx-sdk.sh](https://github.com/ClearNode/ClearCoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
clr/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ClearNode/ClearCoin/blob/master/doc/README_osx.md) for troubleshooting tips.
