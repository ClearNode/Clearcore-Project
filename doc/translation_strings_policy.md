...
This document provides guidelines for internationalization of the ClearCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `clr_en.ts` remains unchanged.
